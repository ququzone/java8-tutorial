...
> [“Java是还没有死，人们开始明白这一点。”](https://twitter.com/mreinhold/status/429603588525281280)

欢迎阅读我的 [Java 8](https://jdk8.java.net/) 介绍教程。 这篇教程引导你一步步的掌握Java8的新语言特点。 通过简洁的代码示例，你将学习到如何使用缺省接口方法，lambda表达式，方法引用以及可重复的注解。阅读完文章后，你将熟悉最新的 [API](http://download.java.net/jdk8/docs/api/) 改动，比如流、函数接口、map扩展以及新的日期接口。**没有大篇幅文字，仅仅是一系列的代码片段，尽情享受吧！**

这篇文章来源于我之前发表的一篇[博客](http://winterbe.com/posts/2014/03/16/java-8-tutorial/). 你应该在 [Twitter](https://twitter.com/winterbe_) 关注我.
...
* [方法引用](#method-and-constructor-references)
* [Lambda 作用域](#lambda-scopes)
